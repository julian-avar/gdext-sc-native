...
object ClassRegistrar:
    ...
    def register(): Unit =
        ...
        info._15 = CFuncPtr.toPtr(_createFn).asInstanceOf[Ptr[Byte]] // create_instance_func (required)
        info._16 = CFuncPtr.toPtr(_freeFn).asInstanceOf[Ptr[Byte]]   // free_instance_func   (required)
