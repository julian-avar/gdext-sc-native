...
object Predef:
    extension (v: Ptr[Vector2])
        ...
        inline def *(o: Vector2): Ptr[Vector2]    = v.combine(o)(_ * _)
        ...
        inline def combine(o: Vector2)(f: (Float, Float) => Float): Ptr[Vector2] =
            val result = stackalloc[Vector2]()
            result.x = f(v.x, o.x)
            result.y = f(v.y, o.y)
            result
    ...
    extension (v: Ptr[Vector2i])
        ...
        inline def *(o: Vector2i): Ptr[Vector2i] = v.combine(o)(_ * _)
        ...
        inline def combine(o: Vector2i)(f: (Int, Int) => Int): Ptr[Vector2i] =
            val result = stackalloc[Vector2i]()
            result.x = f(v.x, o.x)
            result.y = f(v.y, o.y)
            result
    ...
    extension (v: Ptr[Vector3])
        ...
        inline def *(o: Vector3): Ptr[Vector3]    = v.combine(o)(_ * _)
        ...
        inline def combine(o: Vector3)(f: (Float, Float) => Float): Ptr[Vector3] =
            val result = stackalloc[Vector3]()
            result.x = f(v.x, o.x)
            result.y = f(v.y, o.y)
            result.z = f(v.z, o.z)
    ...
    extension (v: Ptr[Vector3i])
        ...
        inline def *(o: Vector3i): Ptr[Vector3i] = v.combine(o)(_ * _)
        ...
        inline def combine(o: Vector3i)(f: (Int, Int) => Int): Ptr[Vector3i] =
            val result = stackalloc[Vector3i]()
            result.x = f(v.x, o.x)
            result.y = f(v.y, o.y)
            result.z = f(v.z, o.z)
