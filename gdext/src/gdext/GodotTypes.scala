...
given Tag[ClassCreationInfo2] = Tag.materializeCStruct22Tag[
    UByte, UByte, UByte,
    Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte],
    Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte],
    Ptr[Byte], Ptr[Byte], Ptr[Byte],
    Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte]
]
