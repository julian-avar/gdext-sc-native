...
class WrappersGenerator(using dialect: Dialect):
    ...
    private def wrapperSource(
        ...
        val baseImports = List(
          ...
          "import com.julianavar.gdext.core.{GdxApi, GodotObject, GodotClass, Ptrcall, StringNames, CanCallApi}"
        )
        ...
        "// Generated by gdext generator — do not edit.\n" +
            buildSource("com.julianavar.gdext.generated", allImports, topStats)
    end wrapperSource
