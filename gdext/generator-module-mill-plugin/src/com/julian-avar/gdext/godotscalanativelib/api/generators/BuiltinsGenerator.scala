...
class BuiltinsGenerator(using dialect: Dialect):
    ...
    private def builtinsSource(
        ...
        val valueStats: List[Stat] = valueTypes.flatMap { b =>
            ...
            val docComment = s"/** Godot value type. Use ${b.name}(...) or ${b
                    .name}.alloc() to create instances. */"
        ...
        "// Generated by gdext generator — do not edit.\n" + buildSource(
          "com.julian-avar.gdext.generated",
          List(
            "import scala.scalanative.unsafe.{*, given}",
            "import scala.scalanative.unsigned.*",
            "import com.`julian-avar`.gdext.core.{ToVariant, FromVariant, ExportType, Variant}"
          ),
