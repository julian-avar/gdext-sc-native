...
object GdClassRegistry:
    ...
    /** Register a user-defined extension class.
      ...
      * Godot base class being extended (which already includes the full ancestor chain). If omitted,
      * no virtuals will be dispatched to Scala.
      *
    ...
    def register(
        ...
        GdClassRegistration(name, parentName, factory, virtuals, properties, methods, signals, isRuntime)
