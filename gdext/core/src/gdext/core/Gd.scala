...
/** Typed reference to a Godot engine object.
  *
  * `Gd[Node]` is what you hold when you receive an engine object from a method call. It is distinct
  * from your own class instance, which extends the generated wrapper class directly.
  *
