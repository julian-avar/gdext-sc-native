...
import com.julianavar.gdext.ffi.{CStruct23, Tags as ExtraStructTags}
import com.julianavar.gdext.ffi.{GDExtensionClassCreationInfo2, GDExtensionPropertyInfo}
...
given Tag[ClassCreationInfo2] =
    import com.julianavar.gdext.ffi.given
