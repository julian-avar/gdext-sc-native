...
import com.`julian-avar`.gdext.ffi.{CStruct23, Tags as ExtraStructTags}
import com.`julian-avar`.gdext.ffi.{GDExtensionClassCreationInfo2, GDExtensionPropertyInfo}
...
given Tag[ClassCreationInfo2] =
    import com.`julian-avar`.gdext.ffi.given
