...
import com.`julian-avar`.gdext.core.virtual.VirtualEntry
import com.`julian-avar`.gdext.core.method.MethodEntry
...
object Register:
    ...
    private def autoImpl[T: Type](using Quotes): Expr[Unit] =
        ...
        val virtualsExpr: Expr[Vector[VirtualEntry]] =
            ...
            val modName   = s"com.julian-avar.gdext.generated.${godotBase}Virtuals"
