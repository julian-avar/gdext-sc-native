            ...
            if blocks.nonEmpty then
                os.write.over(
                  ...
                  s"""// Generated by RegistrationScan — do not edit.
                    |package $sigPkg
                    |
                    |import com.`julian-avar`.gdext.core.{Signal0, Signal1, Signal2, Signal3, GodotObject}
                    |import com.`julian-avar`.gdext.core.{ToVariant, FromVariant, given}
                    |import com.`julian-avar`.gdext.generated.{*, given}
                    |
                    |$blocks
                    |""".stripMargin
                )
        ...
        if found.nonEmpty then
            ...
            os.write.over(
              ...
              s"""// Generated by RegistrationScan — do not edit. Fingerprint: $fingerprint
                |package $pkg
                |
                |import com.`julian-avar`.gdext.core.Register
                |import com.`julian-avar`.gdext.generated.{*, given}
                |
            ...
            if !userHasEntry then
                os.write.over(
                  ...
                  s"""// Generated by RegistrationScan — do not edit. Fingerprint: $fingerprint
                    ...
                    |        com.`julian-avar`.gdext.GodotEntry.init(getProcAddress, library, initPtr)
                    |    end godotScalaInit
                    |end GeneratedEntry
                    |""".stripMargin
                )
