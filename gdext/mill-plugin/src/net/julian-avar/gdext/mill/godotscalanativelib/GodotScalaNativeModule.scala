            ...
            if blocks.nonEmpty then
                os.write.over(
                  ...
                  s"""// Generated by RegistrationScan — do not edit.
                    |package $sigPkg
                    |
                    |import net.`julian-avar`.gdext.core.{Signal0, Signal1, Signal2, Signal3, GodotObject}
                    |import net.`julian-avar`.gdext.core.{ToVariant, FromVariant, given}
                    |import net.`julian-avar`.gdext.generated.{*, given}
                    |
                    |$blocks
                    |""".stripMargin
                )
        ...
        if found.nonEmpty then
            ...
            os.write.over(
              ...
              s"""// Generated by RegistrationScan — do not edit. Fingerprint: $fingerprint
                |package $pkg
                |
                |import net.`julian-avar`.gdext.core.Register
                |import net.`julian-avar`.gdext.generated.{*, given}
                |
            ...
            if !userHasEntry then
                os.write.over(
                  ...
                  s"""// Generated by RegistrationScan — do not edit. Fingerprint: $fingerprint
                    ...
                    |        net.`julian-avar`.gdext.scala.ScalaScriptBootstrap.registerClasses()
                    |        net.`julian-avar`.gdext.GodotEntry.init(getProcAddress, library, initPtr,
                    |            onSceneInit = () => net.`julian-avar`.gdext.scala.ScalaScriptBootstrap.activateLanguage())
                    |    end godotScalaInit
                    |end GeneratedEntry
                    |""".stripMargin
                )
