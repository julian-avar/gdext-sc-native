...
- `gdext/core/src/com/julianavar/gdext/core/GdArray.scala` — `ToVariant`, `FromVariant`, `destroy`, `foreach`
- `gdext/core/src/com/julianavar/gdext/core/GdDict.scala` — `ToVariant`, `FromVariant`, `destroy`, `foreach`
