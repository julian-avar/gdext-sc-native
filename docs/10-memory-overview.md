...
| File | Role |
|------|------|
| `gdext/core/src/com/julianavar/gdext/core/Gd.scala` | `Gd[T]` handle: `free()`, `unref()`, `close()`, `cast` |
| `gdext/core/src/com/julianavar/gdext/core/GodotObject.scala` | Base class: `ptr`, `connect`/`disconnect` |
| `gdext/core/src/com/julianavar/gdext/core/GdArray.scala` | Typed Array value wrapper |
| `gdext/core/src/com/julianavar/gdext/core/GdDict.scala` | Typed Dictionary value wrapper |
| `gdext/core/src/com/julianavar/gdext/core/GdxApi.scala` | FFI function pointers, `CallbackRegistry`, `variantDestroyPtr` |
| `gdext/core/src/com/julianavar/gdext/core/VariantTypeclasses.scala` | `ToVariant`/`FromVariant` instances |
| `gdext/core/src/com/julianavar/gdext/core/PropertyDescriptor.scala` | Property metadata + Variant helpers |
| `gdext.core`'s `PackedArrays.scala` (compile-time generated by `CoreGeneratorModule`) | Packed array extension methods |
| `gdext/core/src/com/julianavar/gdext/core/ClassRegistrar.scala` | Instance maps, create/free/recreate |
| `gdext/core/src/com/julianavar/gdext/core/Callables.scala` | `CallableLambda` factory |
| `gdext/core/src/com/julianavar/gdext/core/Ptrcall.scala` | Ptrcall dispatchers (stack-allocated args/ret) |
