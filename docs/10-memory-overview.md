...
- **Automatic:** Every virtual dispatch creates a Zone, so `ready`/`process` overrides
...
| File | Role |
|------|------|
| `gdext/core/src/com/julian-avar/gdext/core/Gd.scala` | `Gd[T]` handle: `free()`, `unref()`, `close()`, `cast` |
| `gdext/core/src/com/julian-avar/gdext/core/GodotObject.scala` | Base class: `ptr`, `connect`/`disconnect` |
| `gdext/core/src/com/julian-avar/gdext/core/GdArray.scala` | Typed Array value wrapper |
| `gdext/core/src/com/julian-avar/gdext/core/GdDict.scala` | Typed Dictionary value wrapper |
| `gdext/core/src/com/julian-avar/gdext/core/GdxApi.scala` | FFI function pointers, `CallbackRegistry`, `variantDestroyPtr` |
| `gdext/core/src/com/julian-avar/gdext/core/VariantTypeclasses.scala` | `ToVariant`/`FromVariant` instances |
| `gdext/core/src/com/julian-avar/gdext/core/PropertyDescriptor.scala` | Property metadata + Variant helpers |
| `gdext.core`'s `PackedArrays.scala` (compile-time generated by `CoreGeneratorModule`) | Packed array extension methods |
| `gdext/core/src/com/julian-avar/gdext/core/ClassRegistrar.scala` | Instance maps, create/free/recreate |
| `gdext/core/src/com/julian-avar/gdext/core/Callables.scala` | `CallableLambda` factory |
| `gdext/core/src/com/julian-avar/gdext/core/Ptrcall.scala` | Ptrcall dispatchers (stack-allocated args/ret) |
