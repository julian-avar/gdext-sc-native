...
- `gdext/core/src/com/julianavar/gdext/core/Gd.scala` — `Gd[T]` class with `free()`, `unref()`, `close()`, `cast`
- `gdext/core/src/com/julianavar/gdext/core/GodotClass.scala` — `isRefCounted`, `wrap`, `derived` macro
